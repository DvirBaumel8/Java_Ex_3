...
public class Constants {
    ...
    public static final String USER_SUGGEST_DEPARTURE_TIME = "userSuggestDepartureTime";
    public static final String USER_SCHEDULE_INT = "userSuggestScheduleInt";
    public static final String USER_SUGGEST_PPK = "userSuggestPPK";
    ...
    public static final String USER_TIME_PARAM = "userRequestTimeParam";
    public static final String ARRIVAL_START = "userRequestArrivalOrStart";
